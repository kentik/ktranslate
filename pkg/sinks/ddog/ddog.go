...
func init() {
	flag.String("ddog_url", "https://api.datadoghq.com/api/v2/series", "URL to post to")
}

func NewSink(log logger.Underlying, registry go_metrics.Registry, config *ktranslate.DDogSinkConfig) (*DDogSink, error) {
	ddog := DDogSink{
